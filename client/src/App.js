    ...
    render () {
        ...
        return drinks
            ? <Container text>
                ...
                <Button.Group inverted color='purple' fluid widths={drinks.length}>
                ...
                <Container>
                    ...
                    {drink.ingredients &&
                    <Segment.Group >
                        {drink.ingredients.map((ingredient, i) => <Segment color='purple' key={i}>{ingredient.description}</Segment>)}
                    </Segment.Group>
                    }
